...
import { Box, Typography, Stack, Chip, Grid, IconButton } from "@mui/material";
      ...
      >
        ...
        <Box sx={{ mb: 6 }}>
          ...
          <Stack direction="row" spacing={1}>
            ...
            <IconButton
              href="mailto:randy.grizzle.engineer@gmail.com"
              aria-label="Email Randy Grizzle"
              sx={{ 
                color: 'primary.main',
            ...
            <IconButton
              href="https://linkedin.com/in/randy-grizzle-b7319744"
              target="_blank"
